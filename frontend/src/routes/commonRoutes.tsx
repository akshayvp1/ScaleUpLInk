...
// // import Dashboard from '../pages/dashborad/dashboradLayout';
...
import CreateNewPassword from "../pages/auth/createNewPassword";
import ProtectedRoute from "../routes/protectedRoute";
import AntiProtectedRoute from "../routes/antiProtectedRoute"; // Import it here
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/forgot-password" element={<AntiProtectedRoute><ForgotPassword /></AntiProtectedRoute>} />
      <Route path="/forgot-password-otp" element={<AntiProtectedRoute><ForgotPasswordOtp /></AntiProtectedRoute>} />
      <Route path="/create-new-password" element={<AntiProtectedRoute><CreateNewPassword /></AntiProtectedRoute>} />
