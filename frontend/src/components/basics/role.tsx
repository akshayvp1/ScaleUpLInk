...
export default function RoleSelectionPage() {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      if (selectedRole === "investor") {
        navigate("/investor/investor-register");
  ...
  return (
    ...
    <div className="min-h-screen flex items-start justify-center bg-gray-100 p-4 pt-19">
      <motion.div
      ...
      >
        <div className="hidden md:flex items-center justify-center bg-white p-8">
          <img src={buinessIMg} alt="Role Selection" className="max-w-xs" />
        </div>
