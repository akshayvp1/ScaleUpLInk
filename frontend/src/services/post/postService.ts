// // Import the correct Post type from your types file
// import { Post } from "../../types/post/post.types";
// import { api } from "../../utils/axiosInterceptor";
// import { RootState, store } from "../../redux/app/store";
// import { createPost } from "../../redux/features/post/postSlice";

// // Create a new interface for the post data coming from your form/modal
...
//       const completePost: Post = response.data;
      
//       // Dispatch the complete post to Redux
//       store.dispatch(createPost(completePost));
...
//       // Dispatch the complete post to Redux
//       store.dispatch(createPost(completePost));
//       const a = store.getState().posts.posts
//       console.log(a,"looooooo")
//       console.log('Post added successfully:', response.data);
//     } catch (error) {
//       console.error('Error adding post:', error);
//       throw error; 
...
//       // Use the api instance to make a GET request to fetch all posts
//       const response = await api.shared.get('/posts'); // Adjust endpoint as per your API
      
//       const posts: Post[] = response.data.post;
      
//       // Dispatch success with fetched posts
...
//       store.dispatch(fetchPostsFailure('Failed to fetch posts'));
//       throw error;
//     }
//   }
// }
...
// // Interface for post data from form/modal
// interface PostFormData {
//   mediaUrl: string;
//   mediaType: 'image' | 'video';
//   caption: string;
...
//       const completePost: Post = response.data.post; // Assuming { message: string, post: IPost }
...
//       // Assuming your API uses authentication headers set by axiosInterceptor
//       const response = await api.shared.get('/posts'); 
      
//       // Adjust based on your backend response structure
//       const posts: Post[] = response.data.posts; // Assuming { message: string, posts: IPost[] }
